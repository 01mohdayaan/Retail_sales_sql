...
-- What are total number of customers?
...
-- Q1. Write SQL query to retrieve all columns for sales made on the date 2022-11-05.
...
SELECT category, 
SUM(total_sale) AS net_sale FROM retail_sale
GROUP BY category;
